...
export default class Net {
    ...
    constructor() {
        ...
        const line1 = this._parseLine(l1, 0xee2d24);
        const line2 = this._parseLine(l2, 0x0b55a0);
        const line3 = this._parseLine(l3, 0x2bbdee);
        const line4 = this._parseLine(l4, 0xfcc204);
        const line5 = this._parseLine(l5, 0x08875c);
        const line9 = this._parseLine(l9, 0x882c81);
        const line10 = this._parseLine(l10, 0x00b0f2);
        const line11 = this._parseLine(l11, 0xed71a7);
